        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-2">
          ...
          >
            ...
            {showCloseButton && (
              <motion.button
                onClick={collapse}
                className={`absolute right-5 top-5 z-30 flex h-10 w-10 items-center justify-center transition-colors rounded-full ${
                  closeButtonClassName ||
                  "text-neutral-100 bg-transparent hover:bg-white/5"
                }`}
                aria-label="Close"
              >
                <X className="h-5 w-5" />
